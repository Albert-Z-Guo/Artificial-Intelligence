...
class NaiveBayesTest(unittest.TestCase):
    ...
    def test1(self):
        ...
        print(fp,fn) # best record so far: 0.9306569343065694 0.7379310344827585
    ...
    #     index_list = []
    #     data_len = len(data)
    #     for i in range(0, data_len, int(data_len/10)):
    #         index_list.append(i)
    #     index_list[-1] = data_len
    #     for i in range(len(index_list)):
    #         if i + 1 < len(index_list):
    #             classifier = nbc.Bayes_Classifier()
    #             b = index_list[i]
    #             e = index_list[i+1]
    #             classifier.train(data[0:b] + data[e:])
    #             predictions = classifier.classify(data[b:e])
    #             fp, fn = f_score(data[b:e],predictions)
    #             print(fp,fn,'\n')
